    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <ul className={styles.description}>
          <li>
            ✅{' '}
            <a href="https://app.netlify.com/plugins/netlify-plugin-cloudinary/install">
              Install the plugin on Netlify
            </a>{' '}
            (or search for &quot;cloudinary&quot;)
          </li>
          <li>
            ✅ Add <code>CLOUDINARY_CLOUD_NAME</code> as a Build Variable
          </li>
          <li>✅ Trigger a new Netlify build</li>
        </ul>
        ...
        <h2 className={styles.title}>Images Transformed to Use Cloudinary</h2>
